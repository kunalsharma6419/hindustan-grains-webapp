                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="amountTotal"
                                value="{{ $promoters_invoice ?? null }}" name="target_amount_received" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Monthly Target Amount</label>
                            <input type="text" class="form-control" value="{{ $target->target_amount ?? null }}"
                                id="targetAmount" name="target_amount">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="salary"
                                value="{{ $target->monthly_salary ?? null }}" name="monthly_salary">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Montly Salary Amount to be Paid</label>
                            <input type="text" class="form-control" id="salaryAmount" value="{{ $monthsalary ?? null }}"
                                name="monthly_salary_amount_to_paid" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Received percent</label>
                            <input type="text" class="form-control" id="savepercent"
                                value="{{ $target->pending_percent ?? null }}" name="pending_percent" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
