    ...
    <div class="container mt-5" style="border:1px solid black;">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <br>
                <span><stron>Ph.No.:</strong>{{$customer_get->phone_number}}</span><br>
                <span><stron>GST.:</strong>{{$customer_get->gst_number}}</span>
            </div>
        </div>
             ...
             <tbody>
                <tr>
                  <td>
                    ...
                    <span><stron>GST.:</strong>06CDKPS2419C1ZO</span>
                </td>
                  <td style="background: gray; text-align: center;"><h4>GST INVOICE</h4></td>
                  <td>
                        <div class="row">
                            <div class="col-6">
